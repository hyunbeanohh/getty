...
const ClubRanking = () => {
  ...
  // 임시 동아리 데이터
  const clubData = [
    { id: 1, name: '디프만', clicks: Math.floor(Math.random() * 1000) + 1, image: Depromeet, description: '디프만은 디자이너와 프로그래머가 만났을 때의 줄임말로, 서비스 기획부터 론칭과 개선까지 다양한 경험을 합니다.', target: 'https://www.depromeet.com' },
    { id: 2, name: 'DDD', clicks: Math.floor(Math.random() * 1000) + 1, image: DDD, description: 'DDD는 개발자와 디자이너가 함께 사이드 프로젝트를 진행하며 서로의 이해와 친목을 쌓는 기회를 제공합니다.', target: 'https://www.dddcommunity.org' },
    { id: 3, name: 'DND', clicks: Math.floor(Math.random() * 1000) + 1, image: DND, description: 'DND는 사이드 프로젝트를 해보고 싶은 개발자와 디자이너가 팀을 이뤄 8주간 프로젝트를 경험하는 비영리단체입니다.', target: 'https://dnd.ac' },
    { id: 4, name: 'YAPP', clicks: Math.floor(Math.random() * 1000) + 1, image: YAPP, description: 'YAPP은 대학생들의 다양한 아이디어와 열정으로 새로운 가치를 만드는 기업형 IT 동아리입니다.', target: 'https://www.yapp.co.kr' },
    { id: 5, name: 'MashUP', clicks: Math.floor(Math.random() * 1000) + 1, image: MashUP, description: 'MashUp은 개발과 디자인에 관심 있는 사람들이 모여 팀별 스터디와 네트워킹을 통해 프로젝트를 진행하는 IT 연합 동아리입니다.', target: 'https://mash-up.kr' },
    { id: 6, name: 'SOPT', clicks: Math.floor(Math.random() * 1000) + 1, image: SOPT, description: 'SOPT는 IT와 벤처창업에 뜻이 있는 대학생들이 모인 연합 IT벤처창업 동아리입니다.', target: 'https://www.sopt.org' },
    { id: 7, name: 'NEXTERS', clicks: Math.floor(Math.random() * 1000) + 1, image: NEXTERS, description: 'NEXTERS는 자유롭게 협업하고 소통하며 IT 인재로 발전하는 것을 목표로 하는 동아리입니다.', target: 'https://www.nexters.co.kr' },
    { id: 8, name: 'Prography', clicks: Math.floor(Math.random() * 1000) + 1, image: Prography, description: 'Prography는 개발자와 디자이너가 함께 서비스를 기획하고 개발하는 프로젝트를 진행합니다.', target: 'https://www.prography.co.kr' },
    { id: 9, name: 'Programming', clicks: Math.floor(Math.random() * 1000) + 1, image: Programming, description: 'Programming은 비전공자들이 파이썬과 장고를 기반으로 웹 개발을 배우는 동아리입니다.', target: 'https://www.programming.co.kr' },
    { id: 10, name: 'AUGS', clicks: Math.floor(Math.random() * 1000) + 1, image: AUGS, description: 'AUGS는 개발과 즐거운 네트워크 형성을 함께하는 대학생들의 모임입니다.', target: 'https://www.augs.co.kr' },
  ];
