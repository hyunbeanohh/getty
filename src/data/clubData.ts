...
export const clubData: Club[] = [
  ...
  },
  {
    ...
    positions: ['프론트엔드', '백엔드','웹','서버'],
    class: 23,
    founded: '2020',
    techStack: ['React', 'Javascript','Node.js','Java','Kotlin','PHP','Swift']
  },
  {
    id: 10,
    name: 'AUGS',
    ...
    positions: ['백엔드','서버','DevOps'],
    class: 9,
    founded: '2021',
    techStack :['백엔드','AWS','Docker','Kubernetes','CI/CD','DevOps']
  }
]; 